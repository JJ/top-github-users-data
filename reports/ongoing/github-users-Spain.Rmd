---
title: "Github users in Spain: a report on geographical distribution of open source production"
author: "JJ Merelo"
date: "27/6/2015"
output: pdf_document
...
The situation is similar if we take into account the aggregated contributions by all users  that have declared their province. Once again, Granada emerges as the winner but the position of Barcelona and Madrid is inverted and a new player, Valladolid, enters the top five. Navarra, due to a single user with more than 20000 contributions, has managed to enter that ranking too, and directly to the second position, with Madrid a distant third. The first 6 positions seem consolidated (and closed by Valladolid), but Bilbao and Sevilla are very close in the 7th and 8th, and Valencia, Asturias and Gipuzkoa (represented by its capital city, Donostya), vying for the next positions.
