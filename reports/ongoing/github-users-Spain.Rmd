...
Apparently, one cluster includes the provinces with the highest productivity and then two provinces which excel in the number of stars given to projects participated by developers there: Madrid, Barcelona, Zaragoza and Granada. A second cluster, in turquoise, includes Sevilla, Tenerife, Bilbao and Álava, which consistently score in the top 10 in every ranking and in some cases the top 5. The following cluster includes  provinces like Salamanca or Pontevedra with some scores in the top, and vinally the red cluster which does not have anything special to show.
