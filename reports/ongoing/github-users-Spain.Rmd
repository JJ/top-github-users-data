...
The situation is similar if we take into account the aggregated contributions by all users that have declared their province. Once again, Granada emerges as the winner, with Navarra, largely due to a single user, as the second. Next, the positions of Barcelona and Madrid is inverted and a new player, Valladolid, enters the top five. The first 6 positions seem consolidated, at least in the last few months, and closed by Zaragoza, but Bilbao and Sevilla are very close in the 7th and 8th, and Álava and Asturias, vying for the next positions up to the tenth. The next positions are very close and the situation is not stable for the time being, with Jaén, Donostia and Valencia virtually with the same number of contributions per person. 
